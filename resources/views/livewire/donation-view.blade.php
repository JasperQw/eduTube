<div class="h-100 w-100 pt-4" style="padding-bottom: 4.5rem;">
  ...
  <div class="w-100 d-flex justify-content-between  ">
    <div style="width: 20rem;" class="mb-3 mx-5">
      <select wire:model.live="education_level" class="form-select" aria-label="Default select example">
  ...
  <div class="h-100 w-100 px-5 grid-container pb-5 overflow-scroll">
    ...
    <div class="card" style="width: 18rem; height: 32rem;">
      ...
      <div class="card-body d-flex flex-column ">
        <h5 class="card-title text-truncate h-100">{{$item->name}}</h5>
        ...
        <a href="/donation/{{$item->id}}" class="btn btn-primary">Detail</a>
      </div>
    </div>
    @empty
