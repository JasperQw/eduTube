...
class StudyWorkplaceTutorialSeeder extends Seeder
{
    /**
    ...
    {
        $record = new StudyWorkplaceTutorial();
            $record->title = "Biologi Form 4 Bab 4 Tutorial";
            ...
            $record = new StudyWorkplaceTutorial();
            $record->title = "Biologi Form 5 Bab 1 Tutorial";
            ...
            $record = new StudyWorkplaceTutorial();
            $record->title = "Form 2 Science Chapter 7 Tutorial";
            ...
            $record = new StudyWorkplaceTutorial();
            $record->title = "Primary 6 Science Chapter 7 Tutorial";
            ...
            $record = new StudyWorkplaceTutorial();
            $record->title = "Markov Chain Tutorial";
